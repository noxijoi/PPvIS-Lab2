...
public class TableComponent {
    ...
    public TableComponent(Composite parent){
        ...
        org.eclipse.swt.widgets.Button firstPage = FormCreator.createButton(group,"<<");
        ...
        org.eclipse.swt.widgets.Button prevPage = FormCreator.createButton(group, "<");
        ...
        Button nextPage = FormCreator.createButton(group,">");
        ...
        Button lastPage = FormCreator.createButton(group,">>");
